...
I actively learn and practice ethical security skills.

- CTF platforms: TryHackMe, Hack The Box, OverTheWire
- Main interests: web exploitation, Linux privilege escalation, networking, and recon
- Tools: Nmap, Burp Suite, Wireshark, SQLMap
- Focused on legal, ethical, and responsible security testing
...
- Full-stack web apps
- Android and mobile app prototypes
- IoT dashboards and sensor monitoring systems
- Embedded firmware and device integrations
- Linux configs and productivity setups
- Cybersecurity labs and practice projects

---

## Featured Interests

- Secure firmware and OTA workflows
- Real-time data dashboards
- Monitoring systems for connected devices
- Clean developer tooling and automation
- Modern web stacks and backend APIs
...
- Sensors web monitoring system
- Global sensors map for Sensors Africa
- Blogging platform with Strapi CMS
- Secure firmware update and device management ideas
- Linux configuration and workflow tooling
...
- Embedded networking
- Security automation
- Better DX for modern full-stack apps
